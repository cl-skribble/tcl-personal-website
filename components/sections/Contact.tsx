          ...
          <FadeIn>
            <div>
              ...
              <a
                ...
                className="flex w-full sm:w-auto sm:inline-flex items-center gap-4 bg-white text-magenta font-bold text-sm px-6 py-4 rounded-2xl hover:bg-white/90 transition-colors group"
              >
